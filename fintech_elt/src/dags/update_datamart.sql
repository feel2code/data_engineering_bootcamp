INSERT INTO STV2024031257__DWH.global_metrics (
    date_update,
    currency_from,
    country,
    amount_total,
...
(WITH inf AS
  (SELECT (%s)::timestamp AS date_update,
   ...
   FROM STV2024031257__STAGING.transactions t
   LEFT JOIN STV2024031257__STAGING.currencies c ON t.transaction_dt::date = c.date_update::date
