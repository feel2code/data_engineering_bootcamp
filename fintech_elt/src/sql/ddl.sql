--DROP TABLE IF EXISTS STV2024031257__STAGING.transactions;
CREATE TABLE IF NOT EXISTS STV2024031257__STAGING.transactions
(
...
CREATE PROJECTION IF NOT EXISTS STV2024031257__STAGING.transactions (
    operation_id,
    account_number_from,
    account_number_to,
    currency_code,
    ...
    FROM STV2024031257__STAGING.transactions
...
--DROP TABLE IF EXISTS STV2024031257__STAGING.currencies;
CREATE TABLE IF NOT EXISTS STV2024031257__STAGING.currencies
(
...
CREATE PROJECTION IF NOT EXISTS STV2024031257__STAGING.currencies (
    date_update,
    currency_code,
    currency_code_with,
    currency_with_div
    ...
    FROM STV2024031257__STAGING.currencies
...
--DROP TABLE IF EXISTS STV2024031257__DWH.global_metrics;
CREATE TABLE IF NOT EXISTS STV2024031257__DWH.global_metrics
(
    date_update timestamp(3) NOT NULL,
